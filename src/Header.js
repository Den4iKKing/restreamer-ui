...
function AboutModal(props) {
	...
	return (
		<Modal open={props.open} onClose={props.onClose} className="modal">
			<ModalContent title="Инфа о Restreamer" onClose={props.onClose} className={classes.modalPaper}>
				<Grid container spacing={1}>
					<Grid item xs={12} className={classes.aboutImage}>
						<PaperThumb image={welcomeImage} title="Welcome to Comedoz Restreamer" height="200px" />
					</Grid>
					<Grid item xs={12}>
						<Typography variant="body1">
						Это внешний интерфейс который сделан от не хуй делать. Спасибо можно сказать{' '}
							<Link color="secondary" href="https://vk.com/den4ikking" target="_blank">
							Den4iK
							</Link>{' '}
							.
						</Typography>
					...
					<Grid item xs={12}>
						...
						<Typography>
							...
							<Link color="secondary" target="_blank" href="https://vk.com/den4ikking">
								By Den4iK
							</Link>
						</Typography>
						<Typography>
							<strong>Donation</strong>:{' '}
							<Link color="secondary" target="_blank" href="https://www.donationalerts.com/r/den4ik_4game">
								Похуй на него
							</Link>
						</Typography>
						<Typography>
			...
			<React.Fragment>
				...
				<StyledMenu anchorEl={$anchorEl} open={$anchorEl !== null} onClose={handleMenuClose} onClick={handleMenuClose} disableScrollLock>
					{props.hasService === true && (
						<React.Fragment>
							<MenuItem component="a" href="https://vk.com/den4ikking" target="blank">
								<ListItemIcon>
			...
			<Grid item xs={12}>
				<Stack direction="row" justifyContent="space-between" alignItems="center" spacing={0}>
					<Stack direction="row" alignItems="center" spacing={0} className="headerLeft">
						...
						<Typography className="headerTitle">ComedozRestreamer</Typography>
					</Stack>
